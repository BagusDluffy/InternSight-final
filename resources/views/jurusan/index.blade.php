...
<div class="content-wrapper">
    ...
    <section class="content">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="d-flex">
                            ...
                            <a href="{{ route('jurusan.download-template') }}" class="btn btn-info">
                    ...
                    <div class="col-md-4 text-center">
                        <form action="{{ route('jurusan.import') }}" method="POST" enctype="multipart/form-data" class="d-flex justify-content-center align-items-center">
                            @csrf
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form id="multiDeleteForm" action="{{ route('jurusan.multi-delete') }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <table class="table table-bordered table-striped" id="jurusanTable">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center align-middle">
                                <td>
                                    <input type="checkbox" name="selected_ids[]" value="{{ $jurusanItem->id }}" class="checkbox-item">
                                </td>
                                <td>{{ $key + 1 }}</td>
...
$(document).ready(function() {
    const table = $('#jurusanTable').DataTable({
        responsive: true,
        autoWidth: false,
        lengthChange: true,
        searching: true,
        ...
        columnDefs: [{
            orderable: false,
            targets: [0, 4] // Disable sorting for checkbox and action columns
        }]
    });
    ...
    $('form[action*="jurusan.import"]').on('submit', function(e) {
        if ($('#importFile').val() === '') {
            e.preventDefault();
    ...
    $('#deleteSelected').on('click', function() {
        ...
        Swal.fire({
            ...
            text: `Anda akan menghapus ${selectedCount} jurusan. Apakah Anda yakin?`,
            icon: 'warning',
    ...
    $('#deleteAll').on('click', function() {
        Swal.fire({
            ...
            text: 'Anda akan menghapus SEMUA data jurusan. Aksi ini tidak dapat dibatalkan!',
            icon: 'warning',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ route('jurusan.delete-all') }}",
                    type: 'DELETE',
                    data: { _token: "{{ csrf_token() }}" },
                    success: function(response) {
                        Swal.fire('Berhasil!', 'Semua data jurusan telah dihapus.', 'success')
